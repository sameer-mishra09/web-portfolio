...
const projects = [
  {
    id: 1,
    title: "Credit Card & Customer Data Analytics",
    category: "Data Analytics",
    description:
      "An end-to-end analytics project using Power BI to visualize credit card usage patterns and customer behavior. Focused on improving response time, identifying risk segments, and enhancing user safety through data-driven insights.",
    image: "/projects/project-1.png",
    tags: ["Power BI", "Data Analytics", "MySQL", "Customer Insights"],
  },
];
